...
const About = () => {
    return (
        <div >
            ...
            {/* about us page info  */}
            <div className="grid  grid-cols-1 md:grid-cols-2 mt-20 mx-2 md:mx-10 ">
                <div className="flex items-center justify-center ">
                    <img src="./images/about-us.webp" alt="about us " className=" rounded shadow-lg" />
                </div>
                <div className="flex flex-col items-start justify-center pr-5 md:pr-28 mt-5 md:mt-0">
                    <h1 className="text-xl text-green-500">
                        Welcome to Pro Learner.
                    </h1>
                    <p className="text-xl md:text-4xl my-5 font-medium	">
            ...
            {/* card item  */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 my-20 mx-1 md:mx-10">
                {/* card item  */}
