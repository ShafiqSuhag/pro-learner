...
import CourseItemPreloader from '../../sections/CourseItem/CourseItemPreloader';
            ...
            <div className="hero min-h-screen bg-base-200">
                <div className="flex-col hero-content lg:flex-row-reverse">
                    ...
                    <div>
                        ...
                        <button onClick={handleBrowseCourseBtn} className="btn bg-green-400 border-0 ">BROWSE ALL COURSES</button>
                    </div>
                </div>
            </div>
            {/* Homepage hero section  */}
